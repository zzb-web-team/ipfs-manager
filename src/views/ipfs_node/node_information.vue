<template>
  <div class="content">
    ...
    >
      ...
      <el-table-column prop="totalCap" label="总空间"></el-table-column>
      <el-table-column prop="occupyCap" label="占用空间"></el-table-column>
      <el-table-column prop="remainingCap" label="剩余空间"></el-table-column>
