  ...
  <div class="content">
    ...
    <div class="seach_title">
      <div class="seach_title_input">
        <el-input placeholder="节点ID，节点IP" v-model="seachinput" @keyup.enter.native="seachipfs()">
          <i slot="suffix" class="el-input__icon el-icon-search" @click="seachipfs"></i>
        </el-input>
      </div>
    ...
    <div class="seach_bottom" v-if="optiondisplay">
      <div class="seach_bottom_tw">
        ...
        <el-button plain @click="resetseach()" class="resetseach_btn">重置</el-button>
      </div>
    ...
    <div style="text-align:right;padding:0 10px 10px 10px;">
      <el-button type="primary" @click="export_Excel()" :disabled="show_export">导出</el-button>
    </div>
    <el-table
      :data="tableData"
      border
        ...
        .then(res => {
          if (res.status == 0) {
            ...
            if (res.data.result.length <= 0) {
              ...
              this.total_cnt = res.data.total - 7;
