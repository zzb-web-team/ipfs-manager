  ...
  <div class="content">
    ...
    >
      ...
      <tr>
        ...
        <td class="device_title_content">{{ dev_devation.online_time }}</td>
      ...
      <tr>
        ...
        <td class="device_title_content">{{ dev_devation.cpu_temperature }}</td>
        <td class="device_title_name">内存占用</td>
        <td class="device_title_content">{{ dev_devation.memory_usage }}</td>
      </tr>
    </table>
    ...
    <div class="content_lab">
      ...
      >
        ...
        <el-table-column prop="server_status" label="设备状态" width="220">
          <template slot-scope="scope">
            <span style="color:red;">{{ scope.row.server_status }}</span>
          </template>
        </el-table-column>
        <el-table-column
        ...
        <el-table-column
          ...
          label="硬盘温度"
        ></el-table-column>
        <el-table-column prop="memory_usage" label="内存占用"></el-table-column>
      </el-table>
    </div>
