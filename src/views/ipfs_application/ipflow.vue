<template>
  <div class="content">
    ...
    <el-breadcrumb separator="/">
      <el-breadcrumb-item>IPFS节点应用</el-breadcrumb-item>
      <el-breadcrumb-item>
        <a href="/">ip流量</a>
      </el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <div>
      <div style="text-align:right;padding: 10px;">
        <el-button type="primary" @click="exportexc()" :disabled="showdisable"
          >导出</el-button
        >
      </div>
      <el-table
      ...
      >
        <el-table-column
          ...
          width="180"
        ></el-table-column>
        <el-table-column prop="dataflow" label="共计使用流量"></el-table-column>
