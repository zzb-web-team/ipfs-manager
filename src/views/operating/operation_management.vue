    ...
    <div>
      ...
      <div class="seach">
        ...
        <div v-if="optiondisplay" class="seach_bottom">
          ...
          <span>操作类型：</span>
          <el-select v-model="value2" placeholder="请选择" @change="seachuser">
            <el-option label="全部" value=""></el-option>
            <el-option
      ...
      <div class="con_lable" style="margin-top:20px;">
        ...
        >
          ...
          <el-table-column prop="description" label="修改值"></el-table-column>
          <el-table-column prop="time_create" sortable label="操作时间"
            ><template slot-scope="scope">
  ...
  methods: {
          ...
          if (res.status == 0) {
            if (res.result.page == 0) {
              if (res.result.les_count == 0) {
                ...
                this.total_cnt = res.result.cols.length + res.result.les_count;
              }
            }
    ...
    geydata2() {
      ...
      actionlog(parmas)
        .then(res => {
          if (res.status == 0) {
            this.tableData2 = this.tableData2.concat(res.result.cols);
            if (res.result.page == 0) {
